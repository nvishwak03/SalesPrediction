...
const useStyles = makeStyles({
  root: {
    maxWidth: '90%',  // Use max-width to control the maximum size
      margin: 'auto',  // Keeps the component centered
      marginTop: '6%',
      marginBottom: '5%',
      padding: '0 5%',  // Adds padding inside the container for better control of content spacing
      borderRadius: '15px',
      overflow: 'hidden',
  },
  card: {
    ...
    borderRadius: '15px',
    boxShadow: '0 3px 5px 2px 1px rgba(0, 0, 0, .3)',  // Optional shadow for aesthetics
    overflow: 'hidden',
    padding: '20px'
  },
  tableHeaderCell: {
